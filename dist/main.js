...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ \"./src/util.js\");\n/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./token */ \"./src/token.js\");\n/* harmony import */ var _animations_squash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animations/squash */ \"./src/animations/squash.js\");\n// index JS file\n\n\n\nconsole.log('webpack is running...')\n\n\ndocument.addEventListener(\"DOMContentLoaded\", () => {\n  console.log(\"DOM fully loaded and parsed\");\n  const canvas = document.getElementById('canvas');\n  const shapes = [\"square\", \"circle\"];\n  const colors = [\"lightred\", \"lightblue\", \"lightgreen\", \"lightyellow\"]\n  var animations = [];\n\n  document.addEventListener('click', ()=> {\n    console.log('clicked!')\n    let dims = _util__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getRandom(10, 50);\n\n    let animation = new _animations_squash__WEBPACK_IMPORTED_MODULE_2__[\"default\"]({\n      token: new _token__WEBPACK_IMPORTED_MODULE_1__[\"default\"]({\n        shape: shapes[_util__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getRandom(0, 1)],\n        color: colors[_util__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getRandom(0, 3)],\n        dimensions: [dims, dims], // [width, height]\n        position: [_util__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getRandom(25, canvas.width / 2), _util__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getRandom(25, canvas.height - 25)],  // [xStartPos - 1/2 * width, yStartPos - 1/2 * height]\n        walls: [0, canvas.height, 0, canvas.width],  // [topW, botW, leftW, rightW]\n        ctx: canvas.getContext('2d'),\n      })\n    })\n    animations.push(animation);\n    render();\n  });\n  function render() {\n    setInterval(() => {\n    canvas.getContext('2d').clearRect(0, 0, canvas.width, canvas.height);\n    animations.forEach((animation) => {\n      animation.render()\n    })}, 20);\n  };\n  render();\n});\n\n//# sourceURL=webpack:///./src/index.js?");
